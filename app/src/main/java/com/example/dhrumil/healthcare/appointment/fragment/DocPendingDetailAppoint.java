...
public class DocPendingDetailAppoint extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_doc_pending_detail_appoint,container,false);
        return view;
    }
    ...
    private void inti() {
        ...
        btn_confirmed = view.findViewById(R.id.btn_confirmed);
    }
}
